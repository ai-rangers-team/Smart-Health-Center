...
**Narration:**
"Hello everyone! Our track is Track 3 : Smart Health, an AI-driven Health Centre & Supply Chain Management System. 
...
**Visual:** Admin clicks **Generate recommendations**. These Recommendations are generated by AI which appears
with typewriter effect: you can see it says transfer paracetamol from surplus centre to deficit
...
**Narration:**
"Ya, so it is built on FastAPI on Cloud Run, Firestore, Firebase Auth, Gemini 2.5 Flash — deployed
